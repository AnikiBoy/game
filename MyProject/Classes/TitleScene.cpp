...
{
    Size visibleSize = Director::getInstance()->getVisibleSize();   // 画面の幅を取得
    Point origin = Director::getInstance()->getVisibleOrigin();     // 原点を取得
     ...
     */
    {
        ...
        auto text = Label::createWithSystemFont("TITLE SCENE", "HiraKakuProN-W6", 48);
